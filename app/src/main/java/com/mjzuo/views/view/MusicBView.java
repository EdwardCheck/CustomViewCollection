...
public class MusicBView extends View {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        mRadius = CommentUtils.dip2px(mContext, 40);
        mStrokeWidth = CommentUtils.dip2px(mContext, 2);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        switch (widthModel) {
            ...
            case MeasureSpec.AT_MOST:
                widthSize = mRadius * 2 + getPaddingLeft() + getPaddingRight() + 2 * mStrokeWidth;
                break;
        ...
        switch (heightModel) {
            case MeasureSpec.UNSPECIFIED:
            case MeasureSpec.AT_MOST:
                heightSize = mRadius * 2 + getPaddingTop() + getPaddingBottom() + 2 * mStrokeWidth;
                break;
            case MeasureSpec.EXACTLY:
                break;
        }
