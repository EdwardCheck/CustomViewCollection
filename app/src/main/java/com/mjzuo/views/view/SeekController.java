 ...
 * @since 19/12/25
 */
public class SeekController extends RelativeLayout {

    private static String TAG = "SeekController";
    ...
    private void init() {
        ...
        lineView = findViewById(R.id.seek_controllor_line);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (y < h / 2 - (seekButton.getHeight() / 2) || y > h / 2 + (seekButton.getHeight() / 2)) {
                    return false;
                }
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                seekButton.layout(0, y - seekButton.getWidth() / 2, seekButton.getWidth(), y - seekButton.getWidth() / 2 + seekButton.getHeight());
                break;
