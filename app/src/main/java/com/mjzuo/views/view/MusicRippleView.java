...
public class MusicRippleView extends View {
    ...
    private PointF circlePointF0;//圆心
    private PointF circlePointF1;//圆心
    ...
    public void startAnima() {
        if(drawTimingThread != null) {
            ...
            drawTimingThread.sendEmptyMessageDelayed(MSG_DRAW1, (int)(animaBotIntervalTime * time));
        }
    }
    ...
    private void init() {
        ...
        mRMinRadius = CommentUtils.dip2px(mContext, 40);
        mCurRadius0 = mRMinRadius;
        mCurRadius1 = mRMinRadius;
        mStrokeWidth = CommentUtils.dip2px(mContext, 1);
        distance = CommentUtils.dip2px(mContext, 5);

        radius = CommentUtils.dip2px(mContext, 5);
        curRadius0 = radius;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        switch (widthModel) {
            ...
            case MeasureSpec.AT_MOST:
                widthSize = mRMaxRadius * 2 + getPaddingLeft() + getPaddingRight() + 2 * mStrokeWidth;
                break;
        ...
        switch (heightModel) {
            case MeasureSpec.UNSPECIFIED:
            case MeasureSpec.AT_MOST:
                heightSize = mRMaxRadius * 2 + getPaddingTop() + getPaddingBottom() + 2 * mStrokeWidth;
                break;
            case MeasureSpec.EXACTLY:
                break;
        }
